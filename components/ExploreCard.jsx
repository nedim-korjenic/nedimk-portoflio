...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick, href }) => (
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start md:h-[240px] s:h-[180px] xs:h-[180px] w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        <a href={href}>
        ...
        <p className="font-normal text-[16px] leading-[20px] text-white uppercase">View topic</p>
